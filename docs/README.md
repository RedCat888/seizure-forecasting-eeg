...
└── src/
    ...
    ├── data/               # Windowing and PyTorch datasets
...
```bibtex
@misc{seizure_forecasting_2026,
  title={Seizure Forecasting from Scalp EEG using Deep Feature Fusion},
  author={Your Name},
  year={2026},
  howpublished={\url{https://github.com/yourusername/seizure-forecasting}}
}
```
